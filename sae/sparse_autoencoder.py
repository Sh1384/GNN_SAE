...
GNN layer2 activations (80-dim expanded to latent space).
...
class TopKSAE(BaseSAE):
    ...
    def __init__(self, input_dim: int = 80, latent_dim: int = 512, k: int = 32):
...
class GatedSAE(BaseSAE):
    ...
    def __init__(self, input_dim: int = 80, latent_dim: int = 512,
...
class SwitchSAE(BaseSAE):
    ...
    def __init__(self, input_dim: int = 80, num_experts: int = 8,
