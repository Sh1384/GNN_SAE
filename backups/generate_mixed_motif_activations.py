...
Saves to: outputs/activations/layer3_new/mixed/
...
def extract_layer2_activation(model: GCNModel, data: Data, device: str = 'cuda') -> torch.Tensor:
    ...
    Returns:
        Layer 3 activation tensor (n_nodes, 64)
    """
    data = data.to(device)
    ...
    with torch.no_grad():
        ...
        layer3_act = model.layer3_activations.cpu()
...
def main():
    ...
    output_dir = Path("outputs/activations/layer3_new/mixed")
